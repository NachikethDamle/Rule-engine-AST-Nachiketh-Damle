...
3. **Start MongoDB**
   ...
   ```bash
   mongodb compass
   Copy the connection string from your local machine and paste the connection string in server.js file.
   ```

4. **Start the Backend Server(On the correct directory)**
